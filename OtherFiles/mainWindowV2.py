...
class Ui_Converter(object):
    def setupUi(self, Converter):
        ...
        self.horizontalLayout_2.addWidget(self.TextCodesGlobalLayout)
        ...
        self.DownloadAssemblyButtonLayout.addItem(spacerItem13)
...
"- Intégral : 0000111100011111 : LSR (immediate) R7, R3, #28 : Logical Shift Right (Immediate)"))
        ...
        self.DownloadAssemblyButton.setText(_translate("Converter", "Download Assembly File"))
